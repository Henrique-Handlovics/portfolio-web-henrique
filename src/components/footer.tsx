        ...
        <section id="contato" className="w-full bg-black text-white py-16">
            ...
            <GridContainer className="flex items-center justify-center flex-col">
                    ...
                    <div className="px-4">
                        <ul className="flex items-start flex-col justify-center gap-8 py-8">
                            <li className="flex items-center gap-8">
                                <svg className=" w-15 h-15 lg:w-20 lg:h-20" xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 24 24">
                                ...
                                <a
                                    ...
                                    className="text-3xl lg:text-4xl font-poppins font-medium hover:text-secondary-gray"
                                    >
                            ...
                            <li className="flex items-center gap-8">
                                <svg className="w-15 h-15 lg:w-20 lg:h-20" viewBox="0 0 24 24" fill="white">
                            ...
                            <li className="flex items-center gap-8">
                                ...
                                <a href="#"
                                className="text-2xl font-poppins font-medium lg:text-4xl hover:text-secondary-gray">
                ...
                <div className="flex items-center gap-4 w-full px-2">
                    ...
                    <span className="text-xl font-medium text-white whitespace-nowrap font-fira lg:text-3xl">Desenvolvido por Henrique Handlovics</span>
